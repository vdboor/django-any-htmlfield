#!/usr/bin/env python
# This code comes from django_wysiwyg/utils.py
# and is therefore (C) 2008-2011 Chris Adams, BSD licensed.


def clean_html(input):
    """
    Makes a fragment of HTML well-formed.
    """
...
def sanitize_html(input):
    """
    Removes unwanted tags in a fragment of HTML.
    """
